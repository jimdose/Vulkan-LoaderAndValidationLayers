...
#
# Adds options used by DispatchTableGenerator object during
# vulkan dispatch table generator construction.
#
# Additional members
...
#
# ---- methods ----
# DispatchTableOutputGenerator(errFile, warnFile, diagFile) - args as for
